...
export async function sendOrderConfirmationEmail(args: OrderConfirmationEmailArgs) {
...
export async function sendSalesOrderAlertEmail(args: SalesOrderAlertArgs) {
...
type DeliveredEmailArgs = {
  email: string;
  firstName?: string | null;
  orderId: string;
};

export async function sendDeliveredThankYouEmail(args: DeliveredEmailArgs) {
...
type DeliveredInvoiceEmailArgs = {
  email: string;
  firstName?: string | null;
  orderId: string;
  currency: string;
...
export async function sendDeliveredInvoiceEmail(args: DeliveredInvoiceEmailArgs) {
  const {
    email,
    firstName,
    orderId,
...
type ConciergeSubmissionEmailArgs = {
  service: "Get Styled" | "Find a Tailor";
  fullName: string;
  email: string;
  phone?: string | null;
...
function formatDetailValue(value: string | string[] | null | undefined): string {
...
export async function sendConciergeSubmissionEmail(args: ConciergeSubmissionEmailArgs) {
...
export async function sendConciergeClientConfirmation(args: {
  service: "Get Styled" | "Find a Tailor";
  fullName: string;
  email: string;
}) {
...
export async function sendOrderShippedEmail(args: ShippedEmailArgs) {
...
export async function sendSalesReviewAlertEmail(args: SalesReviewAlertArgs) {
  const {
    email,
    productName,
    reviewerName,
